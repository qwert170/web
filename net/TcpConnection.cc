...
void web::net::defaultConnectionCallback(const TcpConnectionPtr& conn)
{
...
void web::net::defaultMessageCallback(const TcpConnectionPtr&,Buffer* buf,Timestamp)
{
  buf->retrieveAll();
}

TcpConnection::TcpConnection(std::shared_ptr<EventLoop> loop,
...
void TcpConnection::send(const string& message)
{
  if (state_ == kConnected)
  {
    ...
    {
      sendInLoop((void *)&message,message.size());
    }
    else
    {
